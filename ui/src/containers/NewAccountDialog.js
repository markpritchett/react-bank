...
class NewAccountDialog extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                <div>
                    <TextField ref="accountName" hintText="Account name" errorText={nameValidationMessage} />
                </div>
                <div>
                    <TextField ref="openingBalance" hintText="Opening Balance" errorText={openingBalanceValidationMessage} />
                </div>
            </Dialog>
        );
    }
